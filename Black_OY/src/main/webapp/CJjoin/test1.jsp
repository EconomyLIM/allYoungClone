    ...
    <!--header-->
        <div id="part_headerWrap">
            <div class="part_header_wrap">
                <h1 class="cj_logo"><span class="logo" id="logo">CJ ONE</span> TRUE LIFESTYLE MEMBERSHIP</h1>
					...
					<div class="box_member">
						...
						<div class="check_member_box">
							...
							<div class="check_member_form">
								...
								<div class="btn_sec">
									<a href="#" class="btn btn_em" id="btnCheRegister" onkeyup="enterKey()">가입여부 확인</a>
								</div> 
							</div>
						</div>
...
<script type="text/javascript" data-import="true" src="/cjmweb/js/modules/formatter.js"></script>
<script type="text/javascript" data-import="true" src="/cjmweb/js/modules/placeholder.js"></script>
=======
<link rel="stylesheet" href="CJbase.css" />
<link rel="stylesheet" href="CJparticipate.css" />
</head>
<body style="">
<!--skip navigation-->
<div class="skipNavi">
...
<script>
<%-- $(function () {
	$("#btnUtelCheck").on("click", function () {
