...
.table_col th.mandatory {background-image:url('/cjmweb/images/common/ico_mandatory.png'); background-repeat:no-repeat; background-position:20px 29px;}
								...
								<div class="table_header">
									<h3 class="h3_tit">기본정보</h3>
									<div class="info"><p class="msg_mandatory" style="padding-left:20px; background:url('https://www.cjone.com/cjmweb/images/common/ico_mandatory.png') no-repeat 0 6px;"><span class="haze">"필수"</span>표시는 필수 입력 항목입니다.</p></div>
								</div>
								<div class="table_col">
									<table>
										<caption>회원기본정보 입력 표로 회원정보 이름, 아이디, 비밀번호, 비밀번호 확인, 생년월일, 휴대전화, 이메일을 나타냅니다.</caption>
										...
										<tbody>
											<tr class="input">
												<th scope="row" class="mandatory" style="background-image:url('https://www.cjone.com/cjmweb/images/common/ico_mandatory.png'); background-repeat:no-repeat; background-position:20px 29px;">
													<label for="input_member_name"><span class="haze">"필수"</span> 이름</label>
												</th>
												<td>
													<span class="input_txt"><input type="text" readonly="" value="이수환" class="text readonly member_name" id="input_member_name"></span><!-- 에러시 .error 클래스 추가 -->
											...
											<tr class="input">
												...
												<td>
													...
													<p class="msg_desc">CGV,CJ온스타일 등 기존의 CJ ONE  제휴 브랜드 회원님의 경우는 기존에 사용하고 계신 아이디가 새롭게 생성하신 통합 아이디로 변경됩니다.</p>
												</td>
											</tr>
											<tr class="input">
												<th scope="row" class="mandatory" style="background-image:url('https://www.cjone.com/cjmweb/images/common/ico_mandatory.png'); background-repeat:no-repeat; background-position:20px 29px;">
