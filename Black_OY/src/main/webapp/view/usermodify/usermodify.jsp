...
<body>
	...
	<div class="mypage-conts">
		...
		<div class="txt-box">
			...
			<ul class="btn_pos">
				<li><a href="javascript:;" class="btn_move"><span>회원정보 	수정</span></a></li>
				<li><a href="javascript:;" class="btn_move"><span>비밀번호 	수정</span></a></li>
			</ul>
		</div>
		<div class="modify_box line mgT40">
			...
			<p class="txt_dg mgT10">※ 회원은 본 서비스 이용 동의에 대한 거부를 할 수 있으며, 미동의 시
				본 서비스에 대한 혜택을 받으실 수 없습니다.</p>
		</div>
				...
				<div class="agreementBox pdzero">
					<div class="contScroll">
						...
						<p>본 약관은 씨제이올리브영 주식회사(이하 “회사”라고 합니다)가 제공하는 위치기반 서비스(이하 “서비스”라고
							합니다)를 이용함에 있어 회사와 회사의 서비스를 이용하는 자(이하 “회원”이라 합니다) 간의 권리·의무 및 기타
							필요한 사항을 규정함을 목적으로 합니다.</p>

						<h2 class="terms-title1" id="TermsOrder1-2">제2조(이용약관의 효력 및
							변경)</h2>
						<ol class="list">
							<li>① 본 약관은 서비스를 신청한 고객 또는 개인위치정보주체가 본 약관에 동의하고 회사 소정의 절차에
								따라 서비스의 이용자로 등록함으로써 효력이 발생합니다</li>
							<li>② 회원이 온라인에서 본 약관의 "동의하기" 버튼을 클릭하였을 경우 본 약관의 내용을 모두 읽고 이를
								충분히 이해하였으며, 그 적용에 동의한 것으로 봅니다.</li>
							<li>③ 회사는 위치기반서비스의 변경사항을 반영하기 위하여 필요한 경우 등에는 위치정보의 보호 및 이용
								등에 관한 법률, 콘텐츠산업 진흥법, 전자상거래 등에서의 소비자보호에 관한 법률, 소비자기본법, 약관의 규제에 관한
						...
						<ol class="list">
							...
							<li class="pdT10">② 회사는 「위치정보의 보호 및 이용 등에 관한 법률」 제16조 제2항에
								따라 위치정보 이용·제공사실 확인자료를 자동 기록·보존하며, 해당 자료는 6개월간 보관합니다.</li>
							<li>③ 회사는 개인위치정보의 이용 또는 제공목적을 달성한 때에는 제3항의 위치정보 이용·제공사실
								확인자료를 제외한 개인위치정보를 즉시 파기합니다. 다만, 다른 법률에 따라 보유하여야 하거나 회원이 개인위치정보의
								보유에 별도로 동의한 경우에는 회원이 동의한 때로부터 최대 1년간 이를 보유할 수 있습니다.</li>
						</ol>
						...
						<ol class="list">
							<li>① 회사는 아래 각 호의 1에 해당하는 사유가 발생한 경우 서비스의 일부 혹은 전부의 이용을
								...
								<ol>
									...
									<li>4.국가비상사태, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 서비스 이용에 지장이 있는
										때</li>
						...
						<ol class="list">
							...
							<li>② 회사는 회원의 동의 없이 개인위치정보를 제3자에게 제공하지 않으며, 제3자에게 제공하는 경우에는
								제공받는 자 및 제공목적을 사전에 회원에게 고지하고 동의를 받습니다. 단, 통계작성, 학술연구 또는 시장조사를
								위하여 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우에는 별도의 동의 없이 제3자에게 개인위치정보를
								제공할 수 있습니다.</li>
							<li>③ 제2항에 따라 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한
								해당 통신 단말장치 또는 전자우편주소 등으로 매회 회원에게 제공받는 자, 제공일시 및 제공목적(이하
								“정보제공내역”이라 합니다)을 즉시 통보합니다. 단, 아래 각 호에 해당하는 경우에는 회원이 미리 특정하여 지정한
								통신단말장치 또는 전자우편주소, 온라인게시 등으로 통보합니다.
								<ol>
							...
							<li>④ 회원은 제1항·제2항에 따른 동의를 하는 경우 이용·제공목적, 제공받는 자의 범위 및
								위치기반서비스 이용약관의 내용 중 일부와 회원의 개인위치정보에 대한 제3자 제공의 경우 통보방법에 대하여 동의를
								유보할 수 있습니다.</li>
						</ol>

						<h2 class="terms-title1" id="TermsOrder1-9">제9조(개인위치정보주체의 권리
							및 행사방법)</h2>
						<ol class="list">
						...
						<h2 class="terms-title1" id="TermsOrder1-11">제11조(8세 이하의 아동
							등의 보호의무자의 권리·의무 및 행사방법)</h2>
						<ol class="list">
							<li>① 회사는 아래의 경우에 해당하는 자(이하 “8세 이하의 아동” 등이라 합니다)의 보호의무자가 8세
								...
								<ol>
									<li>1. 8세 이하의 아동</li>
									<li>2. 피성년후견인</li>
									<li>3. 「장애인복지법」 제2조제2항제2호의 규정에 의한 정신적 장애를 가진 자로서 「장애인고용촉진
										및 직업재활법」 제2조제2호의 규정에 의한 중증장애인에 해당하는 자(「장애인복지법」 제32조의 규정에 의하여
										장애인등록을 한 자에 한한다)</li>
						...
						<ol class="list">
							...
							<li>② 회사 또는 회원은 위치정보와 관련된 분쟁에 대해 당사자간 협의가 이루어지지 아니하거나 협의를 할
								수 없는 경우에는 「개인정보보호법」 규정에 의한 개인정보분쟁조정위원회에 조정을 신청할 수 있습니다.</li>
						</ol>
	...
	<jsp:include page="/layout/footer.jsp"></jsp:include>
		...
		<script
			src="https://static.oliveyoung.co.kr/pc-static-root/js/mypage/customer.js?dumm=202311090002"></script>
		...
		<script type="text/javascript">
			...
			common
					.initBraze(
							'a288b8d5-d6ca-4ffb-87ec-92b04ab45e8a',
							'https://sdk.iad-05.braze.com/api/v3',
							typeof hashedGtmMbrNo !== 'undefined' ? hashedGtmMbrNo
									: '',
							typeof hashedSsoMbrNo !== 'undefined' ? hashedSsoMbrNo
									: '');
		</script>
	...
	var _cngPwdUrl 	= "/cjmweb/member/change-passwd-step.do?coopco_cd=7030&brnd_cd=3000&mcht_no=3000";
	$(function() {
		try {
			callLogEvent("마이정보_회원정보 수정 진입 페이지", getEventParameterObject());
		}catch (e) { console.error(e);}

		common.gnb.setMypageMenu("0501");
		customer.mktRcvInit();
	});
</script>
	</div>
