		...
		<div id="Contents">
			...
			<ul class="comm5sTabs" id="ulDelivGb">
				<li quickyn="N" class="on"><button type="button"
						data-attr="장바구니^Tab^일반 배송" title="선택됨">일반 배송 (0)</button></li>
				<li quickyn="Y"><button type="button"
						data-attr="장바구니^Tab^오늘 드림">오늘드림&amp;픽업 (0)</button></li>
			</ul>
			<!--// 일반배송, 당일배송 탭 -->
						...
						<c:set var="totalPrice" value="${0}" scope="page" />
							<c:forEach items="${ list }" var="bpl">
								...
								<tr soldoutyn="N" cno="677745447" goodsno="${bpl.productID }"
									itemno="002" lgcgoodsno="8809643061308" oripno="" pno=""
...
$(document).ready(function() {
    $(".delete").click(function() {
        ...
        window.location.href = "<%=contextPath%>/olive/delete.do?productid=" + goodsno;
