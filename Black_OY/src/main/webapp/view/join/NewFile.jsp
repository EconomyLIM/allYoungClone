					...
					<div class="member_data">
						...
						<div class="member_info">
							<form id="form1" method="post" action="">
							    ...
							    <input type="hidden" id="id_validate" name="id_validate" value="Y">
									...
									<table>
										...
										<tbody>
											...
											<tr class="input">
												...
												<td>
													<div class="input_group">
														...
														<p class="msg_info em hide" id="alert_mbr_id" style="display: block;">사용가능한 아이디입니다.</p>
													</div>
											...
											<tr class="input">
												...
												<td>
													<div class="input_group">
														<span class="input_txt w250"><input type="password" class="text error" placeholder="비밀번호를 입력해주세요." name="pwd" id="pwd" maxlength="50"></span>
														<span class="pwd_lv" id="alert_pwd_strength"><em>강도 : 강함 </em></span>
														<p class="msg_info em" id="msg_pwd" style="display: none;"><em>영문자, 숫자, 특수문자 모두 최소 1가지 이상 조합하여 8~12자리로 설정 가능합니다.</em></p>
													</div>
											...
											<tr class="input">
												...
												<td>
													<div class="input_group">
														...
														<p class="msg_info em hide" id="msg_pwd_check" style="display: none;">입력하신 비밀번호가 일치하지 않습니다. 다시 확인해 주세요.</p>
													</div>
												</td>
											</tr>
											<tr class="input">
												...
												<td>
													<div class="birthday_select">
														...
														</span><div class="select_wrap w70 strack">	<div class="item_seleced"><a href="#04" title="생년월일 중 월 선택 목록 열기" data-title="생년월일 중 월 선택" class="">04<span class="haze">선택됨</span></a></div>	<div class="item_list_wrap ">		<div class="item_list ui_scrollarea">			<ul class="ui_content"><li><a href="#" class=""><span>월</span></a></li><li><a href="#01"><span>01</span></a></li><li><a href="#02"><span>02</span></a></li><li><a href="#03" class=""><span>03</span></a></li><li><a href="#04" class="" data-selected="true"><span>04</span></a></li><li><a href="#05"><span>05</span></a></li><li><a href="#06"><span>06</span></a></li><li><a href="#07"><span>07</span></a></li><li><a href="#08"><span>08</span></a></li><li><a href="#09"><span>09</span></a></li><li><a href="#10"><span>10</span></a></li><li><a href="#11"><span>11</span></a></li><li><a href="#12"><span>12</span></a></li></ul>		</div>		<div class="scroll ui_scrollbar">			<span class="bg_top"></span>			<span class="bg bg_mid" style="height: 74.0513px; transform: translate(0px, 0px);"></span>			<span class="bg_btm"></span>		</div>	</div></div>
														<span class="symbol">월</span>
														<span class="select w70 hide" data-skin="form">
															<select title="생년월일 중 일 선택" class="narrow" id="birth_dd" name="birth_dd"><option value="">일</option><option value="01" selected="selected">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option></select>
														</span><div class="select_wrap w70 strack">	<div class="item_seleced"><a href="#03" title="생년월일 중 일 선택 목록 열기" data-title="생년월일 중 일 선택" class="">03<span class="haze">선택됨</span></a></div>	<div class="item_list_wrap ">		<div class="item_list ui_scrollarea">			<ul class="ui_content"><li><a href="#" class=""><span>일</span></a></li><li><a href="#01" class=""><span>01</span></a></li><li><a href="#02" class=""><span>02</span></a></li><li><a href="#03" class="" data-selected="true"><span>03</span></a></li><li><a href="#04"><span>04</span></a></li><li><a href="#05"><span>05</span></a></li><li><a href="#06"><span>06</span></a></li><li><a href="#07"><span>07</span></a></li><li><a href="#08"><span>08</span></a></li><li><a href="#09"><span>09</span></a></li><li><a href="#10"><span>10</span></a></li><li><a href="#11"><span>11</span></a></li><li><a href="#12"><span>12</span></a></li><li><a href="#13"><span>13</span></a></li><li><a href="#14"><span>14</span></a></li><li><a href="#15"><span>15</span></a></li><li><a href="#16"><span>16</span></a></li><li><a href="#17"><span>17</span></a></li><li><a href="#18"><span>18</span></a></li><li><a href="#19"><span>19</span></a></li><li><a href="#20"><span>20</span></a></li><li><a href="#21"><span>21</span></a></li><li><a href="#22"><span>22</span></a></li><li><a href="#23"><span>23</span></a></li><li><a href="#24"><span>24</span></a></li><li><a href="#25"><span>25</span></a></li><li><a href="#26"><span>26</span></a></li><li><a href="#27"><span>27</span></a></li><li><a href="#28"><span>28</span></a></li><li><a href="#29"><span>29</span></a></li><li><a href="#30"><span>30</span></a></li></ul>		</div>		<div class="scroll ui_scrollbar">			<span class="bg_top"></span>			<span class="bg bg_mid" style="height: 31.0538px; transform: translate(0px, 0px);"></span>			<span class="bg_btm"></span>		</div>	</div></div>
												...
												<td>
													<div class="email_write">
														...
														<span class="input_txt w110">
															<input type="text" class="text small" title="이메일 도메인 입력" name="email_addr2" id="email_addr2" value="" placeholder="이메일 도메인" data-format="email" autocomplete="off">
														</span>
														...
														</span><div class="select_wrap w100">	<div class="item_seleced"><a href="#0" title="이메일 도메인 선택 목록 열기" data-title="이메일 도메인 선택" class="">직접입력<span class="haze">선택됨</span></a></div>	<div class="item_list_wrap ">		<div class="item_list ui_scrollarea">			<ul class="ui_content"><li><a href="#0" class="" data-selected="true"><span>직접입력</span></a></li><li><a href="#naver.com" class=""><span>네이버</span></a></li><li><a href="#hanmail.net" class=""><span>한메일</span></a></li><li><a href="#nate.com" class=""><span>네이트</span></a></li><li><a href="#gmail.com" class=""><span>지메일</span></a></li></ul>		</div>		<div class="scroll ui_scrollbar" style="display: none;">			<span class="bg_top"></span>			<span class="bg bg_mid" style="display: none;"></span>			<span class="bg_btm"></span>		</div>	</div></div>
														<p class="msg_info em hide" id="alert_email_addr" style="display: none;">유효하지 않는 이메일 주소 입니다.</p>
													</div>
...
<div class="footer_wrap">			
	...
	<div class="fixedTop" data-control="goTop" style="bottom: 107.875px;"><a href="#headerWrap" title="페이지 처음으로 이동" class=""><span class="haze">TOP</span></a></div>
...
<script type="text/javascript" data-import="true" src="/cjmweb/js/modules/formatter.js"></script><script type="text/javascript" data-import="true" src="/cjmweb/js/modules/placeholder.js"></script></body>
