...
<div id="Container">
		...
		<div class="coupon-area">
			<ul class="comm5sTabs tab2">
				<li><button type="button" onclick="javascript:location.href='<%=contextPath%>/olive/membership.do'">올리브 멤버스</button></li>
				<li class="on"><button type="button" id="couponButton" title="선택됨" onclick="javascript:location.href='<%=contextPath%>/olive/coupon.do'">쿠폰/혜택</button></li>
			</ul>
			<c:choose>
				...
				<c:otherwise>
					<div class="TabsConts on">
						<div class="text-login">
							...
							<a href="<%=contextPath%>/olive/LogOn.do">로그인</a>
						</div>
						<a class="couponEnroll-link" href="#" id="getCouponLPop" data-rel="layer" data-target="discountCoupon" data-attr="멤버십쿠폰^쿠폰혜택탭^쿠폰등록"><span>쿠폰 등록<em>발급 받으신 번호를 등록해주세요</em></span></a><!-- 2017-01-17 수정 : 레이어띄우는 부분 추가 -->
					</div>
				</c:otherwise>
