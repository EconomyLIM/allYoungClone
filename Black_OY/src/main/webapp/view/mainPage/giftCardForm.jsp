		...
		<div id="Contents">
			...
			<table class="tbl_inp_form">
				...
				<tr>
					...
					<td><input type="text" id="ordManNm" name="ordManNm" value="${logOn.u_name }" class="inpH28" title="주문자명을 입력해주세요." style="width:200px" data-attr="주문자정보^1_주문자명"></td><!-- id와 label for를 맞춰주세요 (임시로 넣어둠) -->
