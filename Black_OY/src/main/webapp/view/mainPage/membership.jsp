	...
	<div id="Wrapper">
		<div id="Container" class="renew-mem-lounge">
			...
			<ul class="comm5sTabs tab2">
				<li class="on">
					<button type="button" title="선택됨" onclick="javascript:location.href='<%=contextPath%>/olive/membership.do'">올리브 멤버스</button>
				</li>
				<li>
					<button type="button" id="couponButton" onclick="javascript:location.href='<%=contextPath%>/olive/coupon.do'">쿠폰/혜택</button>
				</li>
			</ul>
						...
						<div class="login-area">
							...
							<div class="login-button-area">
								<button type="button" class="button-login"
									onclick="javascript:location.href='<%=contextPath%>/olive/LogOn.do'">로그인하기</button>
							</div>
						</div>
