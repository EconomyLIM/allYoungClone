			...
			<div class="grd-box">
				<div class="info_user clrfix">
					...
					<ul class="mem_opt">
						...
						<li id="profileModify"><a href="javascript:common.wlog('mypage_profile');" onclick="mypage.header.goReviewerProfile('RFRPOENqK1dLNzdvMGdWbHhWc09OQT09', {t_page: '마이페이지', t_click: '나의프로필이미지'})">나의 프로필</a></li>
					</ul>
				</div>
				...
				<div class="point-box ">
					<ul class="infor clrfix" id="pointInfo">
						<li id="cjOnePoingInfo" onclick="location.href='https://www.oliveyoung.co.kr/store/mypage/getCJOnePointInfo.do'+'?'+ getEventParameterString({t_page: '마이페이지', t_click: 'CJONE포인트'})">
							...
							<a class="num" href="javascript:;">?<em class="unit">P</em></a>
						</li>
						<li id="couponList" onclick="location.href='https://www.oliveyoung.co.kr/store/mypage/getCouponList.do'+'?'+ getEventParameterString({t_page: '마이페이지', t_click: '쿠폰'})">
							...
							<a class="num" href="javascript:;" data-attr="마이페이지^쿠폰^쿠폰함이동">?<em class="unit">개</em></a>
						</li>
					...
					<ul>
						...
						<li><h2>마이 활동</h2>
							<ul>
								...
								<li class="subMenu"><a href="javascript:;" mymenuid="0402" data-ref-linkurl="https://www.oliveyoung.co.kr/store/mypage/getGdasList.do" data-attr="마이페이지^메뉴^리뷰" data-tracking-properties="t_page=마이페이지&amp;t_click=리뷰">리뷰 (<span class="num_review" id="_gdasPossibleTotCnt"></span>)<img src="https://static.oliveyoung.co.kr/pc-static-root/image/comm/icon_lnb_new2.png" class="new" id="_newGdasPossible" style="" alt="신규 리뷰 작성"></a></li>
						...
						<li><h2>마이 정보</h2>
							<ul>
								<li class="subMenu on"><a href="javascript:;" mymenuid="0501" data-ref-linkurl="https://www.oliveyoung.co.kr/store/mypage/getMktReceiptInfo.do" data-attr="마이페이지^메뉴^회원정보 수정" data-tracking-properties="t_page=마이페이지&amp;t_click=회원정보수정">회원정보 수정</a></li>
