...
<jsp:include page="/layout/head.jsp"></jsp:include>
	...
	<!-- 구매 날짜, 유형 선택 -->
	<jsp:include page="/view/mypage/layout/searchoption.jsp" flush="false"></jsp:include>
						...
						<tr>
							...
							<td class="subject ">
								<div class="area">
									...
									<a class="thum"
										href="<%= contextPath%>/olive/productDetail.do??goodsNo=${ol.uodDisplN}&displNum=${ol.uodcmid}${ol.uodcsid}">
										<img
										src="${ ol.uodDisplsrc }"
										alt="${ ol.uodDisplN }"
