							...
							<div class="prd_option_box optionType1 type2" id="buy_option_box">
								...
								<ul class="sel_option_list new" id="option_list">
									...
									<c:forEach items="${pLists}" var="pll">
										<li class="type1"> 
											<a style="cursor: pointer" href="#" id="LinkId${pll.proId}" onclick="displayDiv('${pll.proId}'); Test2();">
												<span class="color">
												...
												<div class="set">
													<span class="option_value"> ${pll.proName}
														<span class="option_price">
															<span class="tx_num"><fmt:formatNumber value="${pll.pafterPrice}" pattern="#,###" />원</span>
														</span>
													</span>
...
var o2oDeliveryYn = "";
	...
	var o2oHldyYn = "";
							...
							<div class="prd_cnt_box ${pli.proId} no_prom" id="${pli.proId}" promno="" infnselimpsyn="N" style="display: none">
								<input type="hidden" id="itemInv_${pli.proId}" value="${pli.proStock}">     
								<input type="hidden" id="itemMinQty_${pli.proId}" value="1">     
								<input type="hidden" id="itemMaxQty_${pli.proId}" value="10">
								<input type="hidden" name="itemNo" value="001">     
								<input type="hidden" name="sGoodsNo" value="${pli.proId}">     
								<input type="hidden" name="itemPrsntYn" value="N">
								<input type="hidden" id="quickYn_A000000188803001" value="N">     
								<input type="hidden" id="itemSalePrc_A000000188803001" value="${pli.pafterPrice }">   
								<div class="tit_area">         
								<span>${pli.proName}
								...
								<button class="btnCalc minus" id="${pli.proId}">
								수량 1감소
								</button>             
								<input type="text" id="input_${pli.proId}" name="" value="0" class="tx_num" title="구매수량" data-price="${pli.pafterPrice}">             
									<button class="btnCalc plus" id="${pli.proId}">
									수량 1증가
									</button>         
								</span>     
							</div>     
							<div class="cont_area">         
							<span class="option_price">
							<span class="tx_num">${pli.pafterPrice}</span>원</span>         
							<a href="#" class="btn_opt_del">선택한 옵션 삭제</a>     
							</div>
							</div>
